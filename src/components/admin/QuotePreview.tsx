...
// CSS-only TM logo for reliable PDF rendering (html2canvas has issues with base64 images from favicon.ico)
const TM_LOGO_HTML = `<div style="width:48px;height:48px;min-width:48px;background:#fff;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-family:'Helvetica Neue',Arial,sans-serif;font-weight:800;font-size:20px;color:#1a1a2e;letter-spacing:-1px;line-height:1;">TM</span></div>`;
