      ...
      <Card className="bg-gradient-to-br from-card to-muted">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <img src="/lovable-uploads/55fddddd-e10a-4c7d-9852-36db51337402.webp" alt={t("studio.galleryAlt1")} loading="lazy" className="w-full h-48 object-cover rounded-md" />
            <img src="/lovable-uploads/85028cc6-173f-44cd-a28f-5aeec1c79bed.webp" alt={t("studio.galleryAlt2")} loading="lazy" className="w-full h-48 object-cover rounded-md" />
            <img src="/lovable-uploads/preamps-pro-pack.webp" alt={t("studio.galleryAlt3")} loading="lazy" className="w-full h-48 object-cover object-top rounded-md" />
          </div>
        </CardContent>
      </Card>
