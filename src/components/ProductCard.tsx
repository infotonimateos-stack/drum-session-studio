  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center px-5 py-3">
        {image ? (
          <div className={`w-full flex items-center justify-center bg-white rounded-xl overflow-hidden ${imageContain ? "h-44" : "h-52"}`}>
            <img
              src={image}
              alt={name}
              className={`w-full h-full ${imageContain ? "object-contain p-2" : "object-cover"}`}
            />
          </div>
        ) : icon ? (
