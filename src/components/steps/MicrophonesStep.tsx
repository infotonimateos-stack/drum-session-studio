          ...
          {baseMicrophones.map(mic => <Card key={mic.id} className="bg-gradient-to-br from-card to-muted border-success/30 hover:shadow-xl transition-all duration-300">
              <CardHeader className="pb-4">
                ...
                {mic.image && <div className="w-full h-32 flex items-center justify-center bg-white rounded-lg">
                     <img src={mic.image} alt={mic.name} className="max-h-28 max-w-full object-contain bg-white rounded-lg p-2" style={{
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-4">
                   ...
                   {mic.image && <div className="w-full h-40 flex items-center justify-center bg-white rounded-lg">
                       <img src={mic.image} alt={mic.name} className="max-h-36 max-w-full object-contain bg-white rounded-lg p-2" style={{
                  filter: 'drop-shadow(0 0 10px rgba(0,0,0,0.1))'
                }} />
                    </div>}
                </CardHeader>
