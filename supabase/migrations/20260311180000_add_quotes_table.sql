-- Create quotes table for budget/quote management
...
-- Allow all operations (admin-only access via edge function with service role key)
CREATE POLICY "Service role full access" ON public.quotes FOR ALL USING (true);

-- Add quote counter series 'P' for Presupuesto
